...
const routes: Routes = [
  ...
  { path: 'property',loadChildren: './property/property.module#PropertyModule', data: { preload: true }},
  { path: 'report',loadChildren: './report/report.module#ReportModule', data: { preload: true }},
  { path: 'transaction',loadChildren: './transaction/transaction.module#TransactionModule', data: { preload: true }},
  { path: 'tenant',loadChildren: './tenant/tenant.module#TenantModule', data: { preload: true }},
  { path: 'lease',loadChildren: './lease/lease.module#LeaseModule', data: { preload: true }},
  { path: 'ulm',loadChildren: './user-listing-management/ulm.module#ULMModule', data: { preload: true }},
  { path: 'my-suggestions' , loadChildren: './my-suggestions/my-suggestions.module#MysuggestionsModule' , data: { preload: true }},
  { path: 'all-suggestions' , loadChildren: './all-suggestions/all-suggestions.module#AllSuggestionsModule' , data: { preload: true }},
