...
@Component({
  selector: 'app-leasegrid',
  templateUrl: './leasegrid.component.html',
  styleUrls: ['./leasegrid.component.css']
})
export class LeasegridComponent implements OnInit {
  LeaseListID: number = 0;
  SuiteNumberSortOrder: string = 'Ascending';
  TenantNameSortOrder: string = 'Ascending';
  ExpirationDateSortOrder: string = 'Ascending';
  ...
  LeaseIDSortOrder: string = 'Ascending';
  FloorNumberSortOrder: string = 'Ascending';
  ExecutionDateSortOrder : string = 'Ascending';
  LeasedSMSortOrder : string = 'Ascending';
  DateOccupiedSortOrder : string = 'Ascending';
    ...
    switch (SortParam) {
      case 'LeaseID':
        if (sortOrder == 'Ascending')
          this.LeaseIDSortOrder = 'Descending';
        else
          this.LeaseIDSortOrder = 'Ascending';
        break;
      case 'PropertyID':
        if (sortOrder == 'Ascending')
      ...
      case 'ExpirationDate':
        if (sortOrder == 'Ascending')
          this.ExpirationDateSortOrder = 'Descending';
        else
          this.ExpirationDateSortOrder = 'Ascending';
        break;

      case 'TenantName':
        if (sortOrder == 'Ascending')
          this.TenantNameSortOrder = 'Descending';
        else
          this.TenantNameSortOrder = 'Ascending';
        break;

      case 'SuiteNumber':
        if (sortOrder == 'Ascending')
          this.SuiteNumberSortOrder = 'Descending';
        else
          this.SuiteNumberSortOrder = 'Ascending';
        break;

      case 'FloorNumber':
        if (sortOrder == 'Ascending')
          this.FloorNumberSortOrder = 'Descending';
        else
          this.FloorNumberSortOrder = 'Ascending';
        break;
      case 'ExecutionDate':
        if (sortOrder == 'Ascending')
          this.ExecutionDateSortOrder = 'Descending';
        else
          this.ExecutionDateSortOrder = 'Ascending';
        break;
      case 'LeasedSM':
        if (sortOrder == 'Ascending')
          this.LeasedSMSortOrder = 'Descending';
        else
          this.LeasedSMSortOrder = 'Ascending';
        break;
      case 'DateOccupied':
        if (sortOrder == 'Ascending')
          this.DateOccupiedSortOrder = 'Descending';
        else
          this.DateOccupiedSortOrder = 'Ascending';
        break;
    }
  }
  ...
  //showPropertySummary(PropertyId, transactionId) {
  ...
  setPage(page: number) {
    ...
    this.isSelectAll = false;
    this.selectedLeaseTransactionList = this._sharedDataService.searchLeaseTransactionList.filter(x => x.isSelected == true);
