...
@Component({
  selector: 'app-tenantsettingsearch',
  templateUrl: './tenantsettingsearch.component.html',
  styleUrls: ['./tenantsettingsearch.component.css']
})
export class TenantsettingsearchComponent implements OnInit {
  ...
  save(){
    ...
    this._userPreferencesService.saveUserPreferences({
      ...
      else
      {
        ...
        communicationModel.Key = "CloseTenantExportsettings";
