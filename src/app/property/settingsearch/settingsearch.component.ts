...
@Component({
  selector: 'app-settingsearch',
  templateUrl: './settingsearch.component.html',
  styleUrls: ['./settingsearch.component.css']
})
  ...
  save() {
    ...
    this._userPreferencesService.saveUserPreferences({
      ...
      if (this.Type == 'Settings')
        ...
        communicationModel.Key = "ClosePropertyExportsettings";
